...
func (s *FeishuSender) fetchUserName(ctx context.Context, idType, id string) (string, error) {
...
var _ connector.UserNameResolver = (*FeishuSender)(nil)
...
func (s *FeishuSender) fetchChatMemberName(ctx context.Context, chatID, memberIDType, memberID string) (string, error) {
	pageToken := ""
	for {
...
var _ connector.ChatMemberNameResolver = (*FeishuSender)(nil)
