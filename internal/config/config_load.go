...
func setCommonConfigDefaults(v *viper.Viper, prefix string, includeRuntimeHTTPAddr bool) {
	...
	v.SetDefault(configKey(prefix, "codex_command"), "codex")
	v.SetDefault(configKey(prefix, "codex_timeout_secs"), 172800)
	v.SetDefault(configKey(prefix, "codex_model"), "")
	v.SetDefault(configKey(prefix, "codex_model_reasoning_effort"), "")
	v.SetDefault(configKey(prefix, "claude_command"), "claude")
	v.SetDefault(configKey(prefix, "claude_timeout_secs"), 172800)
	v.SetDefault(configKey(prefix, "gemini_command"), "gemini")
	v.SetDefault(configKey(prefix, "gemini_timeout_secs"), 172800)
	v.SetDefault(configKey(prefix, "kimi_command"), "kimi")
	v.SetDefault(configKey(prefix, "kimi_timeout_secs"), 172800)
	...
	v.SetDefault(configKey(prefix, "permissions.codex.chat.sandbox"), "workspace-write")
	v.SetDefault(configKey(prefix, "permissions.codex.chat.ask_for_approval"), "never")
	v.SetDefault(configKey(prefix, "permissions.codex.work.sandbox"), "danger-full-access")
	v.SetDefault(configKey(prefix, "permissions.codex.work.ask_for_approval"), "never")
