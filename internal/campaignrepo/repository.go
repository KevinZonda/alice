...
type TaskFrontmatter struct {
	...
	IntegrationRetryCount    int        `yaml:"integration_retry_count" json:"integration_retry_count,omitempty"`
	...
	SelfCheckDigest          string     `yaml:"self_check_digest" json:"self_check_digest,omitempty"`
